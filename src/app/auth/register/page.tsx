  ...
  return (
    <div className="flex min-h-[80vh] flex-col items-center justify-center px-6 py-8">
      <div className="mb-8 text-center">
        ...
        <h1 className="text-2xl font-black" style={{ color: '#E8F0FF' }}>Create Account</h1>
      ...
      {errors.google && <p className="mb-4 w-full rounded-lg px-3 py-2 text-sm" style={{ background: 'rgba(255,77,77,0.1)', color: '#FF6B6B', border: '1px solid rgba(255,77,77,0.2)' }}>{errors.google}</p>}

      <div className="mb-6 flex w-full items-center gap-3">
        <div className="flex-1 border-t border-border" />
        <span className="text-xs" style={{ color: '#7A91BB' }}>or</span>
        <div className="flex-1 border-t border-border" />
      </div>

      <form onSubmit={handleSubmit} className="flex w-full flex-col gap-4">
        {errors.submit && <p className="rounded-lg px-3 py-2 text-sm" style={{ background: 'rgba(255,77,77,0.1)', color: '#FF6B6B', border: '1px solid rgba(255,77,77,0.2)' }}>{errors.submit}</p>}
